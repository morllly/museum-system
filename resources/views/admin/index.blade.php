    ...
    <div class="grid xl:grid-cols-4 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="col-span-2 min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div class="mb-2 text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ asset('file/Экспонаты_пример.xlsx') }}" download class="text-purple-600 hover:text-purple-800">здесь</a>.
            </div>
            <div class="text-gray-600 dark:text-gray-400">
                Осуществлять экспорт можно как всей базы в целом, так и отдельно выбранных экспонатов.
            </div>
