            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-3" id="show" style="cursor: pointer">
                                <div class="flex items-center text-sm">
                            ...
                            <td class="px-4 py-3 text-sm" id="show" style="cursor: pointer">
                                $ 369.95
                            </td>

                            <td class="px-4 py-3 text-xs" id="show" style="cursor: pointer">
                                <span
